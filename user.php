    ...
    <div class="half">
        ...
        <table>
            ...
            <tbody>
                ...
                $sql = "SELECT request_no,date_time,request_date,start_time,end_time,status FROM request WHERE student_reg = ?"; // You can adjust the WHERE clause based on your application logic
                $stmt = $conn->prepare($sql);
                $stmt->bind_param("s", $regId); // Assume $studentId is fetched from session or a validated source
                $stmt->execute();
